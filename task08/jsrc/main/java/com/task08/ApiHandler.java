...
public class ApiHandler implements RequestHandler<Void, String> {
    ...
    public record Hourly(List<Number> temperature_2m, List<String> time, List<Number> relative_humidity_2m,
                         List<Number> wind_speed_10m) {
    ...
    public record CurrentUnits(Number temperature, String time, String interval, String temperature_2m,
                               String wind_speed_10m) {

    }

    public record Current(Number temperature, String time, String interval, String temperature_2m,
                          String wind_speed_10m) {

    }

    public record WeatherResponse(Number latitude, Number longitude, Number utc_offset_seconds, Number elevation,
                                  Number generationtime_ms,
